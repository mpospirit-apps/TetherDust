  ...
  return (
    <div>
      ...
      <form onSubmit={onSubmit} className="card" style={{ maxWidth: 640 }}>
        ...
        <FormField label="Description" help="Helps the agent understand what this repo contains.">
          <textarea
            className="form-control"
            rows={3}
        ...
        <FormField label="Repository URL" help="e.g. https://github.com/owner/repo">
          <input
            className="form-control"
            value={form.repo_url}
            required
        ...
        <FormField label="Branch" help="Leave blank to use the repository's default branch.">
          <input
            className="form-control"
            value={form.branch}
        ...
        <FormField label="Subpath" help="Optional sub-directory to scope to (e.g. services/api).">
          <input
            className="form-control"
            value={form.subpath}
        ...
        <FormField label="Include globs" help="One glob per line, e.g. src/**. Empty = everything.">
          <textarea
            className="form-control"
            rows={2}
        ...
        >
          <input
            ...
            placeholder={hasToken ? "••••••••  (leave blank to keep)" : "Enter GitHub token"}
        ...
        <div className="form-actions">
          <button type="submit" className="btn btn-primary" disabled={save.isPending}>
            {save.isPending ? "Saving…" : isEdit ? "Save Changes" : "Add Codebase"}
          </button>
          <Link to="/admin/codebases" className="btn btn-ghost">
            Cancel
          </Link>
