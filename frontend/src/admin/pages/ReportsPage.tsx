...
export function scheduleLabel(r: ReportDefinition): string {
  switch (r.schedule_type) {
    ...
    case "weekly":
      return `Weekly${
        r.schedule_day_of_week != null ? ` on ${WEEKDAYS[r.schedule_day_of_week]}` : ""
      }`;
    case "monthly":
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1>Reports</h1>
          <p>Scheduled SQL reports — run manually or on a schedule, deliver in-app or by email</p>
        </div>
      ...
      <div className="card">
        {isLoading ? (
          ...
          <div className="empty-state">
            ...
            <h3>No Reports</h3>
            <p className="text-sec">Define a SQL report to run on demand or on a schedule.</p>
                  ...
                  <tr key={r.id}>
                    ...
                    <td>
                      <div className="flex-gap">
                        ...
                        <Link to={`/admin/reports/${r.id}`} className="btn btn-ghost btn-sm">
                          Edit
                        </Link>
                        <button
                          type="button"
                          ...
                          onClick={() => {
                            if (window.confirm(`Delete report "${r.name}"?`)) remove.mutate(r.id);
                          }}
                        >
                          Delete
                        </button>
