...
import { createUser, getUser, listRoles, updateUser, type UserInput } from "../../api/admin";
...
const EMPTY: UserForm = { username: "", email: "", password: "", is_active: true, role: "" };
...
export function UserFormPage() {
  ...
  const save = useMutation({
    mutationFn: () => {
      ...
      return isEdit ? updateUser(numericId as number, payload) : createUser(payload);
    },
    onSuccess: () => {
    ...
    <div>
      ...
      <form onSubmit={onSubmit}>
        <div className="card" style={{ maxWidth: 560 }}>
          ...
          <FormField label="Password" help={isEdit ? "Leave blank to keep existing." : undefined}>
            <input
              className="form-control"
              type="password"
