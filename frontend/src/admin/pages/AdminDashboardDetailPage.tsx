...
export function AdminDashboardDetailPage() {
  ...
  const remove = useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ["admin", "charts", dashboardId] }),
    ...
    <div>
      <div className="page-header">
        ...
        <div className="flex-gap">
          ...
          <Link to={`/admin/dashboards/${dashboardId}/charts/new`} className="btn btn-primary">
            + Add Chart
          </Link>
        </div>
      </div>
      ...
      <div className="card">
        {charts.isLoading ? (
          ...
          <div className="empty-state">
            ...
            <h3>No Charts</h3>
            <p className="text-sec">Add a chart with a SQL query and D3 code.</p>
            <Link
