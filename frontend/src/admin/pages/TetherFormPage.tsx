...
export function TetherFormPage() {
  ...
  const sources = useQuery({ queryKey: ["admin", "tether-sources"], queryFn: getTetherSources });
  ...
  return (
    <div>
      ...
      <form onSubmit={onSubmit} className="card" style={{ maxWidth: 640 }}>
        ...
        <FormField label="Database documentation" help="The database side of this tether.">
          <select
            className="form-control"
        ...
        <div className="form-actions">
          <button type="submit" className="btn btn-primary" disabled={save.isPending}>
            {save.isPending ? "Saving…" : isEdit ? "Save Changes" : "Create & Generate"}
          </button>
          <Link to="/admin/tethers" className="btn btn-ghost">
            Cancel
          </Link>
