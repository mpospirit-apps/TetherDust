...
import { activateAgent, deleteAgent, listAgents, type Agent } from "../../api/admin";
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1>Agents</h1>
          <p>Configure and activate the AI agent. Only one is active at a time.</p>
        </div>
      ...
      <div className="card">
        {isLoading ? (
          ...
          <div className="empty-state">
            ...
            <h3>No agents yet</h3>
            <p className="text-sec">Add an agent and activate it to start chatting.</p>
                    ...
                    <td>
                      <div className="flex-gap">
                        ...
                        <button
                          ...
                          title={a.is_active ? "Switch agents before deleting" : ""}
                          onClick={() => onDelete(a)}
                        >
                          Delete
                        </button>
