...
const SIDEBAR: SidebarSection[] = [
  ...
  },
  {
    heading: "Monitoring",
    items: [
      { to: "/admin/report-runs", label: "Report Runs", icon: "fa-clock-rotate-left" },
      { to: "/admin/docgen-logs", label: "Doc Generation", icon: "fa-file-circle-check" },
      { to: "/admin/chartgen-logs", label: "Chart Generation", icon: "fa-chart-pie" },
        ...
        {SIDEBAR.map((section) => (
          <div className="sidebar-section" key={section.heading}>
            ...
            {section.items.map((item) => (
              <NavLink key={item.to} to={item.to} end={item.end} className={sidebarClass}>
                <span className="icon">
