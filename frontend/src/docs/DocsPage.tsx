...
import { type DocTreeNode, getDocContent, getDocSources } from "../api/docs";
	...
	return (
		<div className="docs-dir">
			...
			>
				<i
					className={
						open ? "fa-solid fa-chevron-down" : "fa-solid fa-chevron-right"
					}
				/>
...
export function DocsPage() {
	...
	useEffect(() => {
		if (
			sourceName &&
			sources.length > 0 &&
			!sources.some((s) => s.name === sourceName)
		) {
			navigate("/docs", { replace: true });
		}
	}, [sourceName, sources, navigate]);
