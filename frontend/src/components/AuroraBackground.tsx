...
const STARS: CSSVars[] = [
  { top: "calc(50% - 120px)", left: "calc(50% - 80px)", "--star-color": "var(--c-cyan)", "--star-delay": "0ms" },
  { top: "calc(50% + 60px)", left: "calc(50% - 220px)", "--star-color": "var(--c-pink)", "--star-delay": "4200ms" },
  { top: "calc(50% - 200px)", left: "calc(50% - 150px)", "--star-color": "var(--c-lime)", "--star-delay": "8500ms" },
  { top: "calc(50% + 150px)", left: "calc(50% + 50px)", "--star-color": "var(--c-red)", "--star-delay": "12800ms" },
  { top: "calc(50% - 50px)", left: "calc(50% + 100px)", "--star-color": "var(--c-orange)", "--star-delay": "17000ms" },
  { top: "calc(50% + 100px)", left: "calc(50% - 300px)", "--star-color": "var(--c-cyan)", "--star-delay": "21500ms" },
];
...
export function AuroraBackground() {
  return (
    <div className="glimmer-container" aria-hidden="true">
      {GLIMMERS.map((style, i) => (
        <div key={i} className="glimmer-dot" style={style} />
      ))}
