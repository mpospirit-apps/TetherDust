  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="dashboards/:id/edit" element={<AdminDashboardFormPage />} />
        <Route path="dashboards/:dashId/charts/new" element={<ChartFormPage />} />
        <Route path="dashboards/:dashId/charts/:chartId" element={<ChartFormPage />} />
