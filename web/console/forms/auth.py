...
class RoleForm(_BaseForm):
    ...
    def __init__(self, *args: object, **kwargs: object) -> None:
        ...
        self.fields["can_manage_users"].help_text = (
            ...
            "grant console access; it only lets a staff user manage users."
        )
        self.fields["is_admin_role"].help_text = (
            "Makes assigned non-superusers staff, grants console access, and "
    ...
    def save(self, commit: bool = True) -> object:
        ...
        if commit:
            ...
            # console access stays aligned with the role's admin flag.
...
class UserCreateForm(_UserModelForm):
    ...
    role = forms.ModelChoiceField(
        ...
        required=False,
        help_text=(
            "Assign a role to this user. Admin roles grant console access and "
