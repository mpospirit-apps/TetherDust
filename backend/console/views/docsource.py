...
def docsource_add_picker_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        request,
        "console/docsources/add_picker.html",
        {
            "section": "docsources",
        },
    )
...
def docsource_generate_page_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        request,
        "console/docsources/generate.html",
        {
            "section": "docsources",
...
def docsource_library_page_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        request,
        "console/docsources/generate_library.html",
        {
            "section": "docsources",
            "databases": DatabaseConnection.objects.filter(is_active=True),
            "doc_sources": DocumentationSource.objects.filter(is_active=True),
...
def docsource_form_view(request: HttpRequest, pk: int | None = None) -> HttpResponse:
    ...
    from core.models import DOC_TYPE_DESCRIPTIONS

    return render(
        request,
        "console/docsources/form.html",
        {
            "form": form,
            "instance": instance,
            "section": "docsources",
...
def _execute_docgen(
    ...
    from core.models import DocGenerationLog as _DocGenLog
...
def _run_docgen_background(
    ...
    from core.models import DocGenerationLog as _DocGenLog
    from core.models import DocumentationSource as _DocSource
