...
def _stub_db_service(monkeypatch: pytest.MonkeyPatch, names: list[str]) -> None:
...
def _registered_tool_fns() -> dict[str, Callable[..., object]]:
...
def test_check_database_access_unfiltered_allows_everything() -> None:
...
def test_check_database_access_enforces_whitelist() -> None:
...
def test_check_database_access_unnamed_resolves_default_and_denies(
...
def test_check_database_access_unnamed_allows_when_default_permitted(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_check_database_access_unnamed_allows_when_nothing_configured(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
async def test_enforce_db_access_short_circuits_before_body() -> None:
    ran = False
...
async def test_database_tool_rejects_disallowed_database(name: str, fn: Any) -> None:
